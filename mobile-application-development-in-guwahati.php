            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-7">
                    <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                        <h1 class="text-white mb-0">Application Development</h1>
                        <div class="custom-breadcrumb">
                            <ol class="breadcrumb d-inline-block bg-transparent list-inline py-0">
                                <li class="list-inline-item breadcrumb-item"><a href="https://peindia.net.in/">Home</a></li>
                                <li class="list-inline-item breadcrumb-item active">Application Development</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-between">
                <div class="col-md-12 col-lg-8">
                    <div class="img-wrap mb-md-4 mb-lg-0">
                        <img src="image/mobile-app-development1.png" alt="Mobile Application Development in Guwahati" class="img-fluid rounded shadow-sm"/>
                    </div>
                </div>
            ...
            <div class="row mt-5">
                <div class="col-md-12">
                    <div class="project-details-content text-color1">
                        <h5 class="aeps-h5">Application Development</h5>
                        <p align="justify">Be visible everytime and connect with your customer at just one touch. We are expert 
                            in developing mobile based application for your business and online shopping portal.</p>
                    </div>
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-md-6">
                    <div class="project-details-feature">
                        <ul class="list-unstyled tech-feature-list">
                            <li class="py-1"><span class="ti-check-box mr-2 color-secondary"></span><strong>Andoid Application</strong></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="project-details-feature">
                        <ul class="list-unstyled tech-feature-list">
                            <li class="py-1"><span class="ti-check-box mr-2 color-secondary"></span><strong>iOS Application</strong></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-around align-items-center">
                <div class="col-md-7">
                    <div class="subscribe-content">
                        <h3 class="mb-1">Looking For Application Development?</h3>
                        <p>Be in touch with your customer at one touch.</p>
                    </div>
                </div>
                <div class="col-md-4">
