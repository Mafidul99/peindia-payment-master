                        ...
                        <div class="card single-promo-card single-promo-hover text-center shadow-sm">
                            <div class="card-body py-5">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted mb-0">Sixmile,Guwahati-22, Assam</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card single-promo-card single-promo-hover text-center shadow-sm">
                            <div class="card-body py-5">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted mb-0">developer@peindia.net.in</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card single-promo-card single-promo-hover text-center shadow-sm">
                            <div class="card-body py-5">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted mb-0">support@peindia.net.in</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-around">
                    ...
                    <div class="col-md-5">
                        <div class="contact-us-content">
                            ...
                            <h5>Office</h5>
                            <h4>Peindia Payments Private Limited</h4>
                            <address>
