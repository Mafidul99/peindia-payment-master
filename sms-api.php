            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-7">
                    <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                        <h1 class="text-white mb-0">Bulk SMS API</h1>
                        <div class="custom-breadcrumb">
                            <ol class="breadcrumb d-inline-block bg-transparent list-inline py-0">
                                <li class="list-inline-item breadcrumb-item">
                                    <a href="https://peindia.net.in/">Home</a></li>
                                <li class="list-inline-item breadcrumb-item active">Bulk SMS API</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mt-5">
                <div class="col-md-12">
                    <div class="project-details-content text-color1">
                        <h5 class="aeps-h5">Bulk SMS API</h5>
                        <p align="justify">SMS has reached heights from the last decade as 90% of your companion are engaged with cell phones.
                         So, BULK SMS Company has gotten charge for promotion in the market. It's being utilized for the advertisement of 
                         products and services. BULK SMS Services helps you to stand out inside the era of competition. It becomes an 
                         innovative process to attract customers. It is a highly interacting and powerful tool in marketing that grabs 
                         a person's eye of audiences.
                        </p>

                        <h5 class="bbps-h4">What can you mean by BULK SMS?</h5>
                        <p align="justify">As we all know the sending a unitary message is known as SMS. So, sending a communication to 
                        the number of users is categorized under BULK SMS. A unique sender id is made for sending BULK SMS. It does not
                     take the fastest-growing channel of promotion. BULK SMS Service Provider acts as a mediator between customer and businessman.
                        </p>
    ...
    <!--project details section end--> <br><br>
                <div class="col-md-12">
                    <div class="img-wrap mb-md-4 mb-lg-0">
                        <img src="img/api-img/bulk-sms-banner-hd-png.png" alt="project" class="img-fluid rounded shadow-sm"/>
                    </div>
                </div>
